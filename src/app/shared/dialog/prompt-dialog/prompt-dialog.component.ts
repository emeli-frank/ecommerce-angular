...
import { ActionDialog, DialogData as ActionDialogData } from '../../../classes/action-dialog';
...
export class PromptDialogComponent extends ActionDialog implements OnInit {
